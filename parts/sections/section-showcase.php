...
<section id="showcases" class="section section-high">
    <div class="inner-section row-1">
        <div class="container">
            <div class="wrapper">
                <div class="top">
                    <h2 class="head head-section">Selected Work From Our Talents</h2>
                </div>
            </div>
        </div>
    </div>
