...
/**
 * Yano Dropdown Post Control.
 *
 * @since   1.0.0
 * @version 1.0.0
 */
final class Yano_Dropdown_Post_Control extends \WP_Customize_Control {
	...
	?>
		<div class="yano-dropdown-post-parent">
			<label>
			...
			<select class="yano-dropdown-post" 
